...
def find_anagrams(name, word_list):
    ...
    print("Number of remaining letter = {}".format(len(name)))
...
def main():
    ...
    while running:
        ...
        if len(temp_phrase) < limit:
            ...
            print("Current anagram phrase =", end=" ", flush=True)
            print(phrase, file=sys.stderr, flush=True)
            ...
            print("\n*****!!!FINISHED!!!*****\n", flush=True)
            print("Anagram of name =", end=" ", flush=True)
            print(phrase, file=sys.stderr, flush=True)
            print()
            try_again = input('\n\nTry again? (y/n):\n ')
